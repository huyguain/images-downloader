(function (ls) {
  ...
  chrome.runtime.onMessage.addListener(function (result) {
    console.log('huynt result', result);
  ...
  function filterImages() {
    ...
    timeoutID = setTimeout(function () {
      ...
      visibleImages = allImages.slice(0).map(imageUrl => {
        chrome.extension.getBackgroundPage().console.log(decodeURI(imageUrl));
        return 'https://m.media-amazon.com/images/I/' + imageUrl.split('%7C')[2];
      });
  ...
  function downloadImages() {
    ...
    function startDownload() {
      ...
      chrome.extension.getBackgroundPage().console.log(visibleImages);
